...
description: Use when editing the VibeResumePDF / Vibe 简历 template, converting resume facts and target roles into a polished HTML resume, preserving one-page web-to-PDF export, and validating the generated PDF.
---

# VibeResumePDF Editor

## Purpose

Use this skill to help a user maintain a resume in the VibeResumePDF template. The source of truth is `index.html` plus `styles.css`; the PDF is generated by `scripts/export-pdf.mjs`.
...
```bash
pdfinfo export/vibe-resume-pdf-demo.pdf
pdftotext export/vibe-resume-pdf-demo.pdf -
```
